            ...
            <div class="card-panel">
                ...
                <div class="panel-header">
                    ...
                    <div class="search-wrap">
                        ...
                        <!--<a href="<%=request.getContextPath()%>/patient/patientDashboard.jsp" class="btn-add">
                        ...
                        <tr data-search="<%= (billingId + " " + appointmentId + " " + status + " " + method).toLowerCase() %>">
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <a href="<%=request.getContextPath()%>/PatientBillingServlet?action=view_installments&billing_id=<%= billingId %>" 

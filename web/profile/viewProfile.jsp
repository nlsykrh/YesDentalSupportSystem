...
<%
    ...
    // ✅ success popup modal uses request attribute "message"
    String successMessage = (String) request.getAttribute("message");
    boolean showSuccessModal = (successMessage != null && !successMessage.trim().isEmpty());

    // ✅ keep error from servlet
...
<div class="overlay">
    ...
    <!-- ✅ SHOW TOP ERROR ONLY if NOT on change password page -->
    <% if (!isChangePassword && request.getAttribute("error") != null) { %>
                    ...
                    <% if (isChangePassword) { %>
                        ...
                        <div class="info-card">
                            ...
                            <div class="card-body-inner">
                                ...
                                <!-- ✅ Show password error INSIDE password form (no popup) -->
                                <% if (errorMsg != null && !errorMsg.trim().isEmpty()) { %>
                                    <div class="alert alert-danger" style="border-radius:12px; max-width:420px; margin:0 auto 14px;">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content" style="border-radius:14px;">
      ...
      <div class="modal-body">
        <%= (successMessage != null ? successMessage : "Successfully updated.") %>
      </div>
    </div>
  </div>
</div>
...
<script>
    // ✅ show modal success ONLY when message exists
    document.addEventListener('DOMContentLoaded', function () {
        const shouldShow = <%= showSuccessModal ? "true" : "false" %>;
        if (shouldShow) {

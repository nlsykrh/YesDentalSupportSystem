                    ...
                    <form id="addStaffForm" action="<%=request.getContextPath()%>/StaffServlet" method="post" novalidate>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="staff_phonenum" required>
                            </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn-save">Create Staff</button>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    staffRole.addEventListener("change", toggleOtherRole);
    toggleOtherRole();

    addStaffForm.addEventListener("submit", function (e) {
        const emailVal = (staffEmail.value || "").trim();
        ...
        if (staffRole.value === "Other" && (otherRoleInput.value || "").trim() === "") {
            e.preventDefault();
            alert("Please specify the staff role.");

...
<script>
    ...
    // ✅ only invalid class, no valid class (no tick)
    ...
    // ✅ Email: only show invalid if user typed something AND format wrong
    ...
    // ✅ Confirm: only show invalid if confirm has value AND mismatch
    ...
    // ✅ Required fields: keep clean while typing, clear red once they start typing
...
<script>
    alert("<%= String.valueOf(request.getAttribute("message")).replace("\"","\\\"") %>");

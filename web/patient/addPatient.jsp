    ...
    <div class="layout-wrap">
        <div class="layout">
            ...
            <div class="sidebar">
                ...
                <a class="side-link"href="<%=request.getContextPath()%>/patient/patientDashboard.jsp"><i class="fa-solid fa-chart-line"></i> Dashboard</a>
                ...
                <a class="side-link active" href="<%=request.getContextPath()%>/PatientServlet?action=list">
                ...
                <form class="flex-form" action="<%=request.getContextPath()%>/PatientServlet" method="post" id="addPatientForm">
                    ...
                    <div class="form-wrap">
                        ...
                        <div class="ic-bar">
                            ...
                            <div>
                                <button type="button" class="btn btn-dark" id="btnCheckIc"
                                        style="border-radius:999px;padding:10px 16px;font-weight:800;">

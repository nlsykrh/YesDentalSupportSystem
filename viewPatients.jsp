...
<head>
    ...
    <style>
        ...
        .layout-wrap {
            ...
            height: calc(100vh - 100px); /* give a fixed area under navbar */
            overflow: hidden;            /* prevent layout-wrap from scrolling */
        }
        .layout{
            display: grid;
       ...
       .sidebar{
            ...
            height: 100%;
            overflow: auto; /* sidebar scroll if too long */
        }
    ...
    <div class="layout-wrap">
        <div class="layout">
            ...
            <div class="sidebar">
                ...
                <a class="side-link active" href="/YesDentalSupportSystem/PatientServlet?action=list">Patients</a>
                <a class="side-link" href="/YesDentalSupportSystem/TreatmentServlet?action=list">Treatments</a>
            </div>
            ...
            <div class="card-panel">
                <div class="panel-header">
                    ...
                    <div class="search-wrap">
                        ...
                        <a href="/YesDentalSupportSystem/patient/addPatient.jsp" class="btn-add">Add Patient</a>
                    </div>
                </div>
